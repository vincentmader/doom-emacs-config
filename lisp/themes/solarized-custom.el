...
(def-doom-theme doom-solarized-dark
  ...
  ; ((bg         '("#002b36" "#002b36" "brightwhite" ))
   ...
   (light-gray '("#BBBBBB" "#BBBBBB" "gray"         ))
   (beige      '("#CCB496" "#CCB496" "yellow"       ))
   (blue_1     '("#04396C" "#04396C" "blue"         ))
   (blue_2     '("#6497B1" "#6497B1" "blue"         ))
   (green_2    '("#357200" "#99bb66" "green"        ))
  ...
  (((font-lock-comment-face &override)
   ...
   ;;;; outline <built-in>
   ((outline-1 &override) :foreground green_2)
   ((outline-2 &override) :foreground blue)
   ((outline-3 &override) :foreground green_2)
   ((outline-4 &override) :foreground blue)
   ((outline-5 &override) :foreground green_2)
   ((outline-6 &override) :foreground blue)
   ((outline-7 &override) :foreground green_2)
   ((outline-8 &override) :foreground blue)
   ; ((outline-4 &override) :foreground (doom-darken blue 0.3))
   ...
   ; ((outline-4 &override) :foreground (doom-darken blue 0.2))
   ; ((outline-6 &override) :foreground (doom-darken beige 0.3))
   ; ((outline-5 &override) :foreground (doom-darken blue 0.3))
   ; ((outline-7 &override) :foreground (doom-darken green 0.6))
   ; ((outline-8 &override) :foreground (doom-darken beige 0.6))
   ; ((outline-4 &override) :foreground blue)
